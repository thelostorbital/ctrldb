...
assert_rejected "$fixture_source_dir/aliased-os-exec-import.go.txt" "$adapter_fixture" no-aliased-os-exec-imports
assert_rejected "$fixture_source_dir/raw-aliased-os-exec-import.go.txt" "$adapter_fixture" no-aliased-os-exec-imports
